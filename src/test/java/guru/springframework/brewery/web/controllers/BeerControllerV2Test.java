...
class BeerControllerV2Test {
    ...
    @Test
    void getBeerByIdV2() throws Exception {
    ...
    public class TestListOperations {
        ...
        @Captor
        ArgumentCaptor<String> beerArgCaptor;

        @Captor
        ArgumentCaptor<BeerStyleEnum> beerStyleEnumArgCaptor;
        ...
        void setUp() {
            ...
            given(beerService.listBeers(
                    beerArgCaptor.capture(),
                    beerStyleEnumArgCaptor.capture(),
